...
open class CustomerRecord() : UpdatableRecordImpl<CustomerRecord>(Customer.CUSTOMER) {
     ...
     */
    constructor(id: Long? = null, shopId: Long? = null, email: String? = null, firstName: String? = null, lastName: String? = null, createdAt: LocalDateTime? = null, updatedAt: LocalDateTime? = null, zip: String? = null): this() {
        this.id = id
        this.shopId = shopId
        this.email = email
