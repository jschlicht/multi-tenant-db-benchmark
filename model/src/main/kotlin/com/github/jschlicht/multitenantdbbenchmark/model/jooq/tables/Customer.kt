...
open class Customer(
     ...
     */
    val SHOP_ID: TableField<CustomerRecord, Long?> = createField(DSL.name("shop_id"), SQLDataType.BIGINT.nullable(false), this, "")
     ...
     */
    val UPDATED_AT: TableField<CustomerRecord, LocalDateTime?> = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "")

    /**
     * The column <code>public.customer.zip</code>.
     */
    val ZIP: TableField<CustomerRecord, String?> = createField(DSL.name("zip"), SQLDataType.VARCHAR.nullable(false), this, "")
